...
/**
 * @title ShipFactory
 * @dev Factory contract to deploy new ships with native token fee collection
 */
contract ShipFactory is OwnerIsCreator, ReentrancyGuard {
    ...
    /**
     * @dev Create a new ship with multiple tokens
     * @param _tokens Array of token addresses
     * @param _amounts Array of token amounts (corresponding to tokens)
     * @param _destinationChainSelector CCIP destination chain
     * @param _capacity Ship capacity (1, 2, 5, or 10)
     */
    function createShip(

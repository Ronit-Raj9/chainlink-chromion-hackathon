...
export function ChainSelector({ type, selectedChain, onChainSelect, launchState, excludeChain }: ChainSelectorProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-6">
      ...
      <div className="relative">
        {/* Main Planet */}
        <motion.div
          className={`relative cursor-pointer ${isDisabled ? "opacity-70 cursor-not-allowed" : ""}`}
        ...
        >
          <motion.div
            ...
            animate={{
              rotate: launchState === "launching" || launchState === "traveling" ? 360 : 0,
            }}
            transition={{
              duration: launchState === "launching" || launchState === "traveling" ? 2 : 0,
              repeat: launchState === "launching" || launchState === "traveling" ? Number.POSITIVE_INFINITY : 0,
              ease: "linear",
            }}
          >
